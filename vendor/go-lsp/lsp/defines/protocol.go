...
type _ServerCapabilities struct {
	...
	//
	// @since 3.17.0
	DiagnosticProvider interface{} `json:"diagnosticProvider,omitempty"` // bool, DiagnosticOptions, DiagnosticRegistrationOptions,
...
type DiagnosticRequest string

const (
	DiagnosticRequestMethod DiagnosticRequest = "textDocument/diagnostic"

	DiagnosticRequestType DiagnosticRequest = "new ProtocolRequestType<DocumentDiagnosticParams, Diagnostic | null, never, void, DiagnosticRegistrationOptions>(method)"
)
